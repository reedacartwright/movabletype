...
## addons/Enterprise.pack/lib/MT/Enterprise/CMS.pm
	...
	'No record found in the file.  Make sure the file uses CRLF as the line ending character.' => 'Keine Einträge in der Datei gefunden. Stellen Sie sicher, daß CRLF für den Zeilenwechsel verwendet wird.',
